export declare const name = "genui";
...
export type { ArtifactRecord, ArtifactVersion, ArtifactView, BuildDiagnostic, FilePatch, Requirement, SourceFile, VerificationEvidence, } from './artifacts/types.ts';
